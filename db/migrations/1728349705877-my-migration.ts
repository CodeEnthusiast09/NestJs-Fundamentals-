...
export class MyMigration1728349705877 implements MigrationInterface {
    name = 'MyMigration1728349705877'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "artists" ("id" SERIAL NOT NULL, "artistName" character varying NOT NULL, "email" character varying NOT NULL, "password" character varying NOT NULL, "userId" integer, CONSTRAINT "UQ_5c65eae62aec298ebe355fe8947" UNIQUE ("email"), CONSTRAINT "REL_f7bd9114dc2849a90d39512911" UNIQUE ("userId"), CONSTRAINT "PK_09b823d4607d2675dc4ffa82261" PRIMARY KEY ("id"))`);
